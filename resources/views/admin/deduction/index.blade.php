...
@section('body')
    <div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
            ...
            @include('admin.deduction.create')
        </div>
            ...
            $(document).ready(function() {
                ...
                $('body').on('click', '.deleteButton', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            ...
                            var url = "{{ route('admin.deduction.destroy', ':id') }}";
                ...
                function loadTable() {
                    ...
                    table = $('#dataTablePayroll').dataTable({
                        ...
                        destroy: true,
                        stateSave: true,
                        ajax: "{{ route('admin.deduction.index') }}",
                ...
                $('body').on('click', '#createButton', function() {
                    ...
                    $.easyAjax({
                        url: '{{ route('admin.deduction.store') }}',
                        type: "POST",
                ...
                $('body').on('click', '#editSaveButton', function() {
                    ...
                    $.easyAjax({
                        url: '{{ route('admin.deduction.update', ['deduction' => 0]) }}',
                        type: "PATCH",
                        container: '#editForm',
                ...
                $('body').on('click', '.editButton', function() {
                    ...
                    var id = $(this).data('id');
                    var url = '{{ route('admin.deduction.edit', ':id') }}';
                    url = url.replace(':id', id);
                    $('#ModalLabel').html("EDIT DEDUCTION");
